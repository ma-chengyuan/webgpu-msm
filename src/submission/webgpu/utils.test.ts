...
const testData: [bigint, Uint32Array][] = [
  ...
  [
    ...
    new Uint32Array([
      256858326, 3006847798, 1208683936, 2370827163, 3854692792, 1079629005,
      1919445418, 2787346268,
    ]),
  ],
  [
    BigInt("60001509534603559531609739528203892656505753216962260608619555"),
    new Uint32Array([
      0, 9558, 3401397337, 1252835688, 2587670639, 1610789716, 3992821760,
      136227,
    ]),
  ],
  [
    BigInt("30000754767301779765804869764101946328252876608481130304309778"),
    new Uint32Array([
      0, 4779, 1700698668, 2773901492, 1293835319, 2952878506, 1996410880,
      68114,
    ]),
  ],
];
...
describe("utils", () => {
  describe("bigIntsToU32Array", () => {
    it.each([
      ...
      "should convert bigints to u32 arrays",
      (bigIntToConvert: bigint, expectedU32Array: Uint32Array) => {
  ...
  describe("bigIntToU32Array", () => {
    it.each(testData)(
      "should convert a bigint to u32 array",
      (bigIntToConvert: bigint, expectedU32Array: Uint32Array) => {
  ...
  describe("u32ArrayToBigInts", () => {
    it.each(testData)(
      "should convert a bigint to u32 array",
      (expectedBigInt: bigint, u32Array: Uint32Array) => {
